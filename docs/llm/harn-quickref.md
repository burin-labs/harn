...
| Generation | `max_tokens`, `temperature`, `top_p`, `top_k`, `logprobs`, `logit_bias`, `min_p`, `repetition_penalty`, `prediction`, `verbosity`, `mirostat`, `stop`, `stop_at_tool_call`, `seed`, `frequency_penalty`, `presence_penalty`, `parallel_tool_calls` |
