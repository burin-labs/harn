...
`.harn-bootstrap-version` pins the published installer-capable seed independently
of the requested runtime, so the same seed can install older Harn releases.
