      ...
      "harn": {
        ...
        "extensionMethods": {
          ...
          "_harn/providerCatalog": {
            ...
            "schema": "https://harnlang.com/schemas/provider-catalog.v5.json",
            "schemaVersion": 5
          },
...
Response `result` is the provider catalog v5 artifact identified by
`https://harnlang.com/schemas/provider-catalog.v5.json`. It is the same shape
