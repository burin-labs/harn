      ...
      "harn": {
        ...
        "extensionMethods": {
          ...
          "_harn/providerCatalog": {
            ...
            "schema": "https://harnlang.com/schemas/provider-catalog.v8.json",
            "schemaVersion": 8
          },
...
Response `result` is the provider catalog v8 artifact identified by
`https://harnlang.com/schemas/provider-catalog.v8.json`. It is the same shape
...
| `mutationStatus` | `tool_call_update` | Stable v1 | Structured workspace mutation outcome: `"applied"`, `"not_applied"`, or `"unknown"`. |
...
| Task lifecycle | `tasks/get`, `tasks/update`, `tasks/cancel`, `notifications/tasks` | Stable MCP tasks extension |
