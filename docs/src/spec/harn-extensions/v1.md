      ...
      "harn": {
        ...
        "extensionMethods": {
          ...
          "_harn/providerCatalog": {
            ...
            "schema": "https://harnlang.com/schemas/provider-catalog.v4.json",
            "schemaVersion": 4
          },
...
Response `result` is the provider catalog v4 artifact identified by
`https://harnlang.com/schemas/provider-catalog.v4.json`. It is the same shape
