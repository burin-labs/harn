      ...
      "harn": {
        ...
        "extensionMethods": {
          ...
          "_harn/providerCatalog": {
            ...
            "schema": "https://harnlang.com/schemas/provider-catalog.v11.json",
            "schemaVersion": 11
          },
...
Response `result` is the provider catalog v11 artifact identified by
`https://harnlang.com/schemas/provider-catalog.v11.json`. It is the same shape
