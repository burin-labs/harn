      ...
      "harn": {
        ...
        "extensionMethods": {
          ...
          "_harn/providerCatalog": {
            ...
            "schema": "https://harnlang.com/schemas/provider-catalog.v7.json",
            "schemaVersion": 7
          },
...
Response `result` is the provider catalog v7 artifact identified by
`https://harnlang.com/schemas/provider-catalog.v7.json`. It is the same shape
