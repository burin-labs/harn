      ...
      "harn": {
        ...
        "extensionMethods": {
          ...
          "_harn/providerCatalog": {
            ...
            "schema": "https://harnlang.com/schemas/provider-catalog.v9.json",
            "schemaVersion": 9
          },
...
Response `result` is the provider catalog v9 artifact identified by
`https://harnlang.com/schemas/provider-catalog.v9.json`. It is the same shape
