...
|---|---|---|---|---:|---:|---:|---:|---:|---:|---|---|---|---:|---|---|---|---|---:|---:|---|---:|---:|
| `anthropic` | `claude-mythos-preview*` | `any; extends` | no | no | no | no | no | yes | no | no | `plain` | `none` | no | `system` | `json` | `none` | `json` | no | yes | `text_only` | yes | no |
| `anthropic` | `anthropic/claude-mythos-preview*` | `any; extends` | no | no | no | no | no | yes | no | no | `plain` | `none` | no | `system` | `json` | `none` | `json` | no | yes | `text_only` | yes | no |
...
| `anthropic` | `claude-opus-*` | `>=5.0; extends` | no | no | no | no | no | yes | no | no | `plain` | `none` | no | `system` | `json` | `none` | `json` | no | yes | `text_only` | yes | no |
...
| `dashscope` | `qwen3.6-plus` | `any; extends` | `enabled` | yes | no | no | no | yes | no | `native` | `markdown` | `delimited` | no | `system` | `json` | `inline` | `native` | yes | yes | `unknown` | yes | no |
...
| `deepinfra` | `*glm-5.2*` | `any` | `enabled` | no | no | no | no | yes | no | `native` | `markdown` | `native_json` | no | `system` | `json` | `inline` | `json` | yes | yes | `native_unreliable` | yes | yes |
| `deepinfra` | `*glm-5*` | `any` | `enabled` | no | no | no | no | yes | no | `native` | `markdown` | `native_json` | no | `system` | `json` | `inline` | `native` | yes | yes | `unknown` | yes | yes |
...
| `fireworks` | `accounts/fireworks/models/qwen3p6-plus` | `any; extends` | `enabled` | yes | no | no | no | yes | no | `native` | `markdown` | `delimited` | no | `system` | `json` | `inline` | `native` | yes | yes | `unknown` | yes | no |
...
| `fireworks` | `accounts/fireworks/models/glm-5p*` | `any` | `enabled` | no | no | no | no | yes | no | `native` | `markdown` | `native_json` | no | `system` | `json` | `inline` | `native` | yes | yes | `unknown` | yes | yes |
...
| `gemini` | `gemini-3.6*` | `any` | `enabled,adaptive,effort` | yes | yes | yes | no | yes | yes | `native` | `xml,markdown` | `native_json` | no | `system` | `json` | `reasoning_summary` | `native` | yes | yes | `unknown` | yes | yes |
| `gemini` | `models/gemini-3.6*` | `any` | `enabled,adaptive,effort` | yes | yes | yes | no | yes | yes | `native` | `xml,markdown` | `native_json` | no | `system` | `json` | `reasoning_summary` | `native` | yes | yes | `unknown` | yes | yes |
| `gemini` | `gemini-3.5-flash-lite` | `any` | `enabled,adaptive,effort` | yes | yes | yes | no | yes | yes | `native` | `xml,markdown` | `native_json` | no | `system` | `json` | `reasoning_summary` | `native` | yes | yes | `unknown` | yes | yes |
| `gemini` | `models/gemini-3.5-flash-lite` | `any` | `enabled,adaptive,effort` | yes | yes | yes | no | yes | yes | `native` | `xml,markdown` | `native_json` | no | `system` | `json` | `reasoning_summary` | `native` | yes | yes | `unknown` | yes | yes |
...
| `huggingface` | `qwen/qwen3.6*` | `any` | `enabled` | no | no | no | no | yes | no | `native` | `markdown` | `delimited` | no | `system` | `json` | `inline` | `text` | yes | yes | `native_unreliable` | yes | no |
...
| `llamacpp` | `*qwen3.6*` | `any` | `enabled` | no | no | no | no | yes | no | `native` | `markdown` | `delimited` | no | `system` | `json` | `inline` | `native` | yes | yes | `interchangeable` | yes | no |
...
| `openrouter` | `qwen/qwen3.6-35b-a3b` | `any; extends` | `enabled` | yes | no | no | no | yes | no | `native` | `markdown` | `delimited` | no | `system` | `json` | `inline` | `native` | yes | yes | `unknown` | yes | no |
| `openrouter` | `qwen/qwen3.6-plus*` | `any; extends` | `enabled` | yes | no | no | no | yes | no | `native` | `markdown` | `delimited` | no | `system` | `json` | `inline` | `native` | yes | yes | `unknown` | yes | no |
| `openrouter` | `anthropic/claude-fable-*` | `any` | no | yes | yes | yes | no | yes | no | `tool_use` | `xml` | `xml_tagged` | no | `system` | `xml` | `thinking_blocks` | `native` | yes | yes | `unknown` | yes | yes |
| `openrouter` | `anthropic/claude-mythos-*` | `any` | no | yes | yes | yes | no | yes | no | `tool_use` | `xml` | `xml_tagged` | no | `system` | `xml` | `thinking_blocks` | `native` | yes | yes | `unknown` | yes | yes |
| `openrouter` | `anthropic/claude-haiku-*` | `>=4.7` | no | yes | yes | yes | no | yes | no | `tool_use` | `xml` | `xml_tagged` | no | `system` | `xml` | `thinking_blocks` | `native` | yes | yes | `unknown` | yes | yes |
| `openrouter` | `anthropic/claude-haiku-*` | `>=4.5` | no | yes | yes | yes | no | yes | no | `tool_use` | `xml` | `xml_tagged` | yes | `system` | `xml` | `thinking_blocks` | `native` | yes | yes | `unknown` | yes | yes |
| `openrouter` | `anthropic/claude-sonnet-*` | `>=4.7` | no | yes | yes | yes | no | yes | no | `tool_use` | `xml` | `xml_tagged` | no | `system` | `xml` | `thinking_blocks` | `native` | yes | yes | `unknown` | yes | yes |
| `openrouter` | `anthropic/claude-sonnet-*` | `>=4.6` | no | yes | yes | yes | no | yes | no | `tool_use` | `xml` | `xml_tagged` | no | `system` | `xml` | `thinking_blocks` | `native` | yes | yes | `unknown` | yes | yes |
| `openrouter` | `anthropic/claude-opus-*` | `>=4.7` | no | yes | yes | yes | no | yes | no | `tool_use` | `xml` | `xml_tagged` | no | `system` | `xml` | `thinking_blocks` | `native` | yes | yes | `unknown` | yes | yes |
| `openrouter` | `anthropic/claude-opus-*` | `>=4.6` | no | yes | yes | yes | no | yes | no | `tool_use` | `xml` | `xml_tagged` | no | `system` | `xml` | `thinking_blocks` | `native` | yes | yes | `unknown` | yes | yes |
| `openrouter` | `anthropic/claude-*` | `any` | no | yes | yes | yes | no | yes | no | `tool_use` | `xml` | `xml_tagged` | yes | `system` | `xml` | `thinking_blocks` | `native` | yes | yes | `unknown` | yes | yes |
...
| `openrouter` | `google/gemini-3.6*` | `any` | `enabled,adaptive,effort` | yes | yes | yes | no | yes | no | `native` | `markdown` | `native_json` | no | `system` | `json` | `reasoning_summary` | `native` | yes | yes | `unknown` | yes | yes |
| `openrouter` | `google/gemini-3.5-flash-lite` | `any` | `enabled,adaptive,effort` | yes | yes | yes | no | yes | no | `native` | `markdown` | `native_json` | no | `system` | `json` | `reasoning_summary` | `native` | yes | yes | `unknown` | yes | yes |
...
| `openrouter` | `z-ai/glm-5*` | `any` | `enabled` | no | no | no | no | yes | no | `native` | `markdown` | `native_json` | no | `system` | `json` | `inline` | `native` | yes | yes | `unknown` | yes | yes |
...
| `together` | `Qwen/Qwen3.6-Plus` | `any; extends` | `enabled` | yes | no | no | no | yes | no | `native` | `markdown` | `delimited` | no | `system` | `json` | `inline` | `native` | yes | yes | `unknown` | yes | no |
...
| `zai` | `glm-5.2*` | `any` | `enabled,effort` | no | no | no | no | yes | no | `native` | `markdown` | `native_json` | no | `system` | `json` | `inline` | `native` | yes | yes | `unknown` | yes | yes |
...
| `zai` | `glm-4*` | `any` | `enabled` | no | no | no | no | yes | no | `native` | `markdown` | `native_json` | no | `system` | `json` | `inline` | `native` | yes | yes | `unknown` | yes | no |
...
| `llamacpp` | `qwen3.6-35b-a3b` | `native` | `interchangeable` | - | - | - | - | - | catalog note: 2026-08-18 Metal receipt, supersedes the 2026-07-19 #5162 CUDA receipt. llama-server b10360-48d22e295 on Apple Silicon, Qwen3.6-35B-A3B-UD-Q4_K_XL, n_ctx 65536, chat template present. This is the SAME quant as the prior receipt's Q4_K_XL row (native 2/12, text 8/12), so it is a directly comparable arm rather than a sibling quant. Six coding-agent fixtures, two replicates, forced through three formats: native 10/12, tagged text 10/12, fenced JSON 8/12. Both failures in EVERY arm were no-tool-diagnosis, whose grader matched phrasing rather than the diagnosis (harn#6843, fixed alongside this row); on the ten measurable cells the arms are native 10/10, text 10/10, json 8/10. Two-sided Fisher separates NOTHING on completion: native vs json p=0.474, native vs text p=1.000. This receipt therefore makes NO claim of a native completion advantage. What it does establish is that native returns parseable tool calls on this route, which falsifies the prior text_only verdict: 58 successful native dispatches including real file edits and command runs. The wire capture names a coercion cost rather than claiming purity: of six chat requests captured through an intercepting proxy, five carried a plain tools array (6 tools, tool_choice null) with NO grammar and NO response_format, and one carried response_format with no tools array, which is the repair/output-contract turn and stays enabled by design. The arm is therefore native over a plain tools channel with the repair-turn contract ACTIVE, not an unconstrained channel. Across the twelve native cells every recorded repair trace reports repaired = false, so no turn's output actually had to be rewritten; that field does not establish whether a decode constraint was imposed on those turns, and the proxy window covers six requests rather than all 58. Pre-registered validity gate, fixed before the matrix was read: any arm with skipped_runs > 0 is INVALID and reruns. All three arms recorded skipped_runs = 0 (native 12 runs, 10 passed 2 failed; text 12, 10/2; json 12, 8/4). preferred_tool_format moved to native on that TIE plus secondary evidence: 158s vs 200s (text) vs 235s (json) total wall, 52 vs 64 vs 66 iterations, and a 3070-character system prompt against 10026 for the text channel, which must teach its dialect every turn. INSTRUMENT DISCLOSURE: the native arm was measured with a local capability override setting native_tools = true, because with native_tools = false no tools array reaches the wire and the arm cannot be measured at all; the text and json arms ran on unmodified capability bytes. Build: branch head c5e1fed2f with harn#6842 (self-hosted routes priced at zero) merged in, without which every budgeted local run ended after one model call and no completion number on this route was meaningful. No single cause is attributed to the reversal from the prior receipt: hardware, runtime build, and revision all differ. server_parser = none. |
| `llamacpp` | `qwen3.6-35b-a3b-ud-q4-k-xl` | `native` | `interchangeable` | - | - | - | - | - | catalog note: 2026-08-18 Metal receipt, supersedes the 2026-07-19 #5162 CUDA receipt. llama-server b10360-48d22e295 on Apple Silicon, Qwen3.6-35B-A3B-UD-Q4_K_XL, n_ctx 65536, chat template present. This is the SAME quant as the prior receipt's Q4_K_XL row (native 2/12, text 8/12), so it is a directly comparable arm rather than a sibling quant. Six coding-agent fixtures, two replicates, forced through three formats: native 10/12, tagged text 10/12, fenced JSON 8/12. Both failures in EVERY arm were no-tool-diagnosis, whose grader matched phrasing rather than the diagnosis (harn#6843, fixed alongside this row); on the ten measurable cells the arms are native 10/10, text 10/10, json 8/10. Two-sided Fisher separates NOTHING on completion: native vs json p=0.474, native vs text p=1.000. This receipt therefore makes NO claim of a native completion advantage. What it does establish is that native returns parseable tool calls on this route, which falsifies the prior text_only verdict: 58 successful native dispatches including real file edits and command runs. The wire capture names a coercion cost rather than claiming purity: of six chat requests captured through an intercepting proxy, five carried a plain tools array (6 tools, tool_choice null) with NO grammar and NO response_format, and one carried response_format with no tools array, which is the repair/output-contract turn and stays enabled by design. The arm is therefore native over a plain tools channel with the repair-turn contract ACTIVE, not an unconstrained channel. Across the twelve native cells every recorded repair trace reports repaired = false, so no turn's output actually had to be rewritten; that field does not establish whether a decode constraint was imposed on those turns, and the proxy window covers six requests rather than all 58. Pre-registered validity gate, fixed before the matrix was read: any arm with skipped_runs > 0 is INVALID and reruns. All three arms recorded skipped_runs = 0 (native 12 runs, 10 passed 2 failed; text 12, 10/2; json 12, 8/4). preferred_tool_format moved to native on that TIE plus secondary evidence: 158s vs 200s (text) vs 235s (json) total wall, 52 vs 64 vs 66 iterations, and a 3070-character system prompt against 10026 for the text channel, which must teach its dialect every turn. INSTRUMENT DISCLOSURE: the native arm was measured with a local capability override setting native_tools = true, because with native_tools = false no tools array reaches the wire and the arm cannot be measured at all; the text and json arms ran on unmodified capability bytes. Build: branch head c5e1fed2f with harn#6842 (self-hosted routes priced at zero) merged in, without which every budgeted local run ended after one model call and no completion number on this route was meaningful. No single cause is attributed to the reversal from the prior receipt: hardware, runtime build, and revision all differ. server_parser = none. |
| `llamacpp` | `qwen3.6-35b-a3b-ud-q5-k-xl` | `native` | `interchangeable` | - | - | - | - | - | catalog note: 2026-08-18 Metal receipt, supersedes the 2026-07-19 #5162 CUDA receipt. llama-server b10360-48d22e295 on Apple Silicon, Qwen3.6-35B-A3B-UD-Q4_K_XL, n_ctx 65536, chat template present. This is the SAME quant as the prior receipt's Q4_K_XL row (native 2/12, text 8/12), so it is a directly comparable arm rather than a sibling quant. Six coding-agent fixtures, two replicates, forced through three formats: native 10/12, tagged text 10/12, fenced JSON 8/12. Both failures in EVERY arm were no-tool-diagnosis, whose grader matched phrasing rather than the diagnosis (harn#6843, fixed alongside this row); on the ten measurable cells the arms are native 10/10, text 10/10, json 8/10. Two-sided Fisher separates NOTHING on completion: native vs json p=0.474, native vs text p=1.000. This receipt therefore makes NO claim of a native completion advantage. What it does establish is that native returns parseable tool calls on this route, which falsifies the prior text_only verdict: 58 successful native dispatches including real file edits and command runs. The wire capture names a coercion cost rather than claiming purity: of six chat requests captured through an intercepting proxy, five carried a plain tools array (6 tools, tool_choice null) with NO grammar and NO response_format, and one carried response_format with no tools array, which is the repair/output-contract turn and stays enabled by design. The arm is therefore native over a plain tools channel with the repair-turn contract ACTIVE, not an unconstrained channel. Across the twelve native cells every recorded repair trace reports repaired = false, so no turn's output actually had to be rewritten; that field does not establish whether a decode constraint was imposed on those turns, and the proxy window covers six requests rather than all 58. Pre-registered validity gate, fixed before the matrix was read: any arm with skipped_runs > 0 is INVALID and reruns. All three arms recorded skipped_runs = 0 (native 12 runs, 10 passed 2 failed; text 12, 10/2; json 12, 8/4). preferred_tool_format moved to native on that TIE plus secondary evidence: 158s vs 200s (text) vs 235s (json) total wall, 52 vs 64 vs 66 iterations, and a 3070-character system prompt against 10026 for the text channel, which must teach its dialect every turn. INSTRUMENT DISCLOSURE: the native arm was measured with a local capability override setting native_tools = true, because with native_tools = false no tools array reaches the wire and the arm cannot be measured at all; the text and json arms ran on unmodified capability bytes. Build: branch head c5e1fed2f with harn#6842 (self-hosted routes priced at zero) merged in, without which every budgeted local run ended after one model call and no completion number on this route was meaningful. No single cause is attributed to the reversal from the prior receipt: hardware, runtime build, and revision all differ. server_parser = none. |
