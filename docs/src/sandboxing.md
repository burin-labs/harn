...
| `side_effect_level >= network` | AppContainer `internetClient` and `privateNetworkClientServer` capability SIDs | outbound public and trusted-private network access; otherwise the AppContainer receives no network capability |
