...
Current live batch adapters cover OpenAI, Anthropic Messages, Mistral, and xAI.
Other catalogued batch providers remain prepare/dry-run only until Harn has a
provider adapter for their submission and result APIs.
