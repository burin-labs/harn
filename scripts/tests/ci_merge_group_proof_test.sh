...
printf '%s\n' '{"total_count":6,"jobs":[{"name":"Format check","status":"completed","conclusion":"success"},{"name":"Rust lint","status":"completed","conclusion":"success"},{"name":"Rust test","status":"completed","conclusion":"success"},{"name":"Harn conformance + audit","status":"completed","conclusion":"success"},{"name":"Audit scripts","status":"completed","conclusion":"success"},{"name":"Windows cross-compile check","status":"completed","conclusion":"success"}]}' > "$successful_jobs"
