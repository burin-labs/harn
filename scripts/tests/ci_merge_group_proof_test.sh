...
printf '%s\n' '{"total_count":11,"jobs":[{"name":"Format check","status":"completed","conclusion":"success"},{"name":"Verify publishable crates","status":"completed","conclusion":"success"},{"name":"Rust lint","status":"completed","conclusion":"success"},{"name":"Rust workspace tests","status":"completed","conclusion":"success"},{"name":"Rust test","status":"completed","conclusion":"success"},{"name":"Run Linux sandbox tests","status":"completed","conclusion":"success"},{"name":"Run Harn conformance tests","status":"completed","conclusion":"success"},{"name":"Check Harn sources and generated files","status":"completed","conclusion":"success"},{"name":"Check repository policies","status":"completed","conclusion":"success"},{"name":"Windows cross-compile check","status":"completed","conclusion":"success"},{"name":"Write CI timing report","status":"completed","conclusion":"success"}]}' > "$successful_jobs"
