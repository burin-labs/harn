...
authored Flow predicate signatures. Attribute diagnostics on attributed type,
struct, enum, interface, and implementation declarations are no longer emitted
twice.
