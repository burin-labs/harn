...
that did the work. The decision is independent of the completion judge, which is
optional and costs a model call, and it convicts only on positive evidence: a
run that used no tools, or whose tool succeeded, still finishes naturally.
