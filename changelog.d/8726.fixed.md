...
wrapper has its server started outside the sandbox first. Only a process the probe build itself started is ever
stopped: other confined processes of the same user, including app-sandboxed system services, are left alone. Three
wrapper cases join the sandbox conformance suite.
