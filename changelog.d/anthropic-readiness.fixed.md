...
- Kept private reasoning/thinking content blocks out of provider replay request
  bodies while preserving internal tool calls and tool results for agent turns.
