...
const RUNTIME_ONLY_EXCEPTIONS: &[&str] = &[
    ...
    "__host_skill_score",
    "__host_tool_balanced_json_len",
    "__host_tool_call_head",
    "__host_tool_decode_entities",
    "__host_tool_json_stream",
    "__host_tool_parse_call_expr",
    "__host_tool_parse_object_literal",
    "__host_tool_render_call",
    "__host_tool_scan_bare_calls",
    "__host_tool_scan_units",
