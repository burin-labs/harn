//! The Swift half of the checked-in provider-catalog binding.
//!
...
pub(super) const SWIFT_TYPES: &str = r#"public struct HarnProviderCatalog: Codable, Sendable, Equatable {
