...
//! defaults) into a [`Capabilities`] value (`lookup_with` plus the `rule_*`
//! field-derivation helpers). The field-by-field projection itself lives in
//! the sibling `projection` module.
...
pub(super) use super::effort::{rule_reasoning_effort_supported, rule_thinking_modes};
