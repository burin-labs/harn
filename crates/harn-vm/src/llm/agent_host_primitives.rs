...
#[harn_builtin(
    sig = "__host_agent_parse_tool_calls(text: string, tools?: {_type: \"tool_registry\", tools: list}|nil, tool_format?: string|nil) -> dict",
    kind = "async",
    category = "agent.host",
    runtime_only = true
)]
...
#[harn_builtin(
    sig = "__host_agent_dispatch_tool_batch(calls: list, tools?: {_type: \"tool_registry\", tools: list}|nil, options?: dict|nil) -> list",
    kind = "async",
    category = "agent.host",
    runtime_only = true
)]
...
#[harn_builtin(
    sig = "__host_agent_dispatch_tool_call(call: dict, tools?: {_type: \"tool_registry\", tools: list}|nil, options?: dict|nil) -> dict",
    kind = "async",
    category = "agent.host",
    runtime_only = true
)]
