...
use super::host::{
    HOST_LLM_USAGE_DELTA_BUILTIN_DEF, HOST_LLM_USAGE_SNAPSHOT_BUILTIN_DEF,
    HOST_STAGE_EXECUTE_ONCE_BUILTIN_DEF, HOST_STAGE_RECORD_ATTEMPT_BUILTIN_DEF,
    HOST_STAGE_SELECT_ARTIFACTS_BUILTIN_DEF, HOST_WORKFLOW_FINALIZE_RUN_BUILTIN_DEF,
    HOST_WORKFLOW_MAP_BRANCH_ARTIFACT_BUILTIN_DEF, HOST_WORKFLOW_MAP_EXECUTE_BRANCH_BUILTIN_DEF,
    HOST_WORKFLOW_MAP_FINALIZE_BUILTIN_DEF, HOST_WORKFLOW_MAP_PLAN_BUILTIN_DEF,
    HOST_WORKFLOW_PREPARE_RUN_BUILTIN_DEF, HOST_WORKFLOW_RECORD_TRANSITIONS_BUILTIN_DEF,
    HOST_WORKFLOW_STAGE_COMPLETE_BUILTIN_DEF, HOST_WORKFLOW_STAGE_PREPARE_BUILTIN_DEF,
};
use super::inspect::{
...
pub(crate) const MODULE_BUILTINS: &[&VmBuiltinDef] = &[
    ...
    // host stage attempt-loop seams (inversion pre-work, design D5 step 1).
    &HOST_STAGE_SELECT_ARTIFACTS_BUILTIN_DEF,
    &HOST_STAGE_EXECUTE_ONCE_BUILTIN_DEF,
    &HOST_STAGE_RECORD_ATTEMPT_BUILTIN_DEF,
    &HOST_LLM_USAGE_SNAPSHOT_BUILTIN_DEF,
    &HOST_LLM_USAGE_DELTA_BUILTIN_DEF,
