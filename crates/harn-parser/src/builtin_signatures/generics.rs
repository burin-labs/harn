...
pub(crate) fn lookup_generic_builtin_sig(name: &str) -> Option<BuiltinGenericSig> {
    match name {
        ...
        "trust.policy_for" => Some(trust_graph_policy_for_builtin_sig()),
        "trust.query" => Some(trust_query_builtin_sig()),
        "trust.record" => Some(trust_graph_record_builtin_sig()),
        "trust.score" => Some(trust_graph_query_builtin_sig()),
        "trust.verify_chain" => Some(trust_graph_verify_chain_builtin_sig()),
