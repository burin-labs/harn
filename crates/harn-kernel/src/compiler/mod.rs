...
pub struct CompiledCallableEntry {
    ...
    #[doc(hidden)]
    pub fixture_expects_harness: bool,
    #[doc(hidden)]
...
impl CompilerOptions {
    ...
    /// Options for source embedded or generated by the Harn runtime.
    ///
    /// This grants private runtime and Harness-method implementation builtins
    /// without granting host wire authority. Only Rust-owned source entry
    /// points may select these options.
    #[doc(hidden)]
    ...
    #[doc(hidden)]
    pub fn privileged_wire_authority(self) -> bool {
    ...
    #[doc(hidden)]
    pub fn legacy_ambient_capabilities(self) -> bool {
