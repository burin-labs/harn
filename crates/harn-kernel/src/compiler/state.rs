...
impl Compiler {
    ...
    /// Compiler for source embedded or generated by the Harn runtime.
    ///
    /// The caller must own the complete source template. This grants private
    /// runtime implementation builtins, but never privileged host wire calls.
    #[doc(hidden)]
