...
pub const STDLIB_SOURCES: &[StdlibSource] = embedded_catalog!(StdlibSource, module, [
    ...
    "dev/agent_gates" => "stdlib/dev/agent_gates.harn",
    "dev/agent_gate_bindings" => "stdlib/dev/agent_gate_bindings.harn",
    ...
    "runtime/install" => "stdlib/runtime/install.harn",
    "runtime/bootstrap" => "stdlib/runtime/bootstrap.harn",
    ...
    "cli/providers/contracts" => "stdlib/cli/providers/contracts.harn",
    ...
    "llm/cache_conformance" => "stdlib/llm/cache_conformance.harn",
    ...
    "agent/required_artifacts" => "stdlib/agent/required_artifacts.harn",
    "agent/loop_turn_setup" => "stdlib/agent/loop_turn_setup.harn",
    "agent/purpose_labels" => "stdlib/agent/purpose_labels.harn",
    "agent/loop_purpose_labels" => "stdlib/agent/loop_purpose_labels.harn",
    ...
    "agent/stall_checkpoint" => "stdlib/agent/stall_checkpoint.harn",
...
pub const STDLIB_PROMPT_ASSETS: &[StdlibPromptAsset] = embedded_catalog!(StdlibPromptAsset, path, [
    ...
    "llm/prompts/missing_tool_call_intent.harn.prompt" => "stdlib/llm/prompts/missing_tool_call_intent.harn.prompt",
    "llm/prompts/missing_tool_call_target.harn.prompt" => "stdlib/llm/prompts/missing_tool_call_target.harn.prompt",
...
pub const STDLIB_CLI_SCRIPTS: &[StdlibCliScript] = embedded_catalog!(StdlibCliScript, name, [
    ...
    "eval/calibrate" => "stdlib/cli/eval/calibrate.harn",
    ...
    "providers/option_probe" => "stdlib/cli/providers/option_probe.harn",
