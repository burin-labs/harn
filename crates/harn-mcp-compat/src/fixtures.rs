//! Shared wire fixtures used by both directions of the stable harness.
//!
...
pub fn fixture_path(name: &str) -> PathBuf {
    ...
    // `crates/harn-mcp-compat` → workspace root is two parents up.
    manifest
        .parent()
...
/// Load and parse every fixture under `spec/protocol-artifacts/fixtures/mcp/`.
