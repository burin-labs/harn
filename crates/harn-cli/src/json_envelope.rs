...
pub fn catalog() -> Vec<SchemaEntry> {
    vec![
        ...
        SchemaEntry {
            ...
            description:
                "LLM spend/usage rollup from the event log: response and provider-call counts, accounting certainty, known cost, tokens, cache telemetry, and time-series cumulatives.",
            schema_json: None,
        },
        SchemaEntry {
            command: "graph",
