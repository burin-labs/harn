...
use super::constants::*;
use super::prepared_session::append_go_prepared_session_types;
use super::session_recap::append_go_session_recap_types;
use super::session_update_payloads::SessionUpdatePayloads;
use super::support::*;
use super::values::*;

pub(super) fn generate_go_artifact(
    session_updates: &SessionUpdatePayloads,
) -> Result<String, String> {
    format_go_source(generate_go_with_payloads(session_updates))
}

#[cfg(test)]
pub(super) fn generate_go() -> String {
    generate_go_with_payloads(&SessionUpdatePayloads::load_for_tests())
}

fn generate_go_with_payloads(payloads: &SessionUpdatePayloads) -> String {
    ...
    payloads.append(&mut out, super::records::Target::Go);
