...
pub(super) fn generate_python() -> String {
    generate_python_with_payloads(&SessionUpdatePayloads::load_for_tests())
}

pub(super) fn generate_python_with_payloads(payloads: &SessionUpdatePayloads) -> String {
    ...
    payloads.append(&mut out, super::records::Target::Python);
