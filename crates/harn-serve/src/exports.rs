...
impl ExportCatalog {
    ...
    pub fn tool_catalog(&self) -> Result<harn_vm::tool_registry::ToolCatalog, DispatchError> {
        use harn_vm::tool_registry::{
            ToolCatalog, ToolCatalogEntry, ToolCatalogSchemaVersion, ToolCliSpec, ToolExecution,
            ToolGovernance, ToolPresentationAnnotations, ToolRegistryInfo, ToolSource,
            ToolTaskSupport,
        };
...
"#,
        ...
        assert_eq!(
            ...
            harn_vm::tool_registry::ToolCatalogSchemaVersion::V1
        );
